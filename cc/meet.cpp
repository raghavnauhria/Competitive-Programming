...
int secondsFrom12(string a, string b)
{
	int ans = 0;

	ans += ((int)(a[3] - '0') * 10 + (int)(a[4] - '0')) * 60;

	ans += (((int)(a[0] - '0') * 10 + (int)(a[1] - '0')) % 12) * 60 * 60;
...
int main()
{
	...
	while(t--)
	{
		...
		fi(i, 0, n)
		{
			...
			int l = secondsFrom12(l1, l2);
			int r = secondsFrom12(r1, r2);
